...
* The original package name 'com.quique.api-funtion' is invalid and this project uses 'com.quique.apifuntion' instead.
...
* [Spring Reactive Web](https://docs.spring.io/spring-boot/docs/3.0.11/reference/htmlsingle/index.html#web.reactive)
